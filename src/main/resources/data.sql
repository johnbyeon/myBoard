...
insert into comment(article_id, nick_name, body) values(4, 'Park', '굿 윌 헌팅');
insert into comment(article_id, nick_name, body) values(4, 'Kim', '아이엠 샘');
insert into comment(article_id, nick_name, body) values(4, 'Choi', '쇼생크탈출');

insert into comment(article_id, nick_name, body) values(5, 'Park', '치킨');
insert into comment(article_id, nick_name, body) values(5, 'Kim', '샤브샤브');
insert into comment(article_id, nick_name, body) values(5, 'Choi', '초밥');

insert into comment(article_id, nick_name, body) values(6, 'Park', '조깅');
insert into comment(article_id, nick_name, body) values(6, 'Kim', '유튜브 시청');
insert into comment(article_id, nick_name, body) values(6, 'Choi', '도서');
